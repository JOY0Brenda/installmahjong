...
SWIFT_CLASS("_TtC14installmahjong11AppDelegate")
...
SWIFT_CLASS("_TtC14installmahjong14ViewController")
@interface ViewController : UIViewController <UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, readonly) NSInteger btnTag;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * __nonnull name_links;
@property (nonatomic, readonly, strong) UIDevice * __nonnull device;
@property (nonatomic, readonly, strong) UITableView * __nonnull table;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (BOOL)shouldAutorotate;
- (BOOL)prefersStatusBarHidden;
- (void)btnClick:(UIButton * __nonnull)sender;
